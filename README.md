...
## Key features
The Asp.Net MVC PDF Viewer component allows to view, print, and annotate the PDF files in your Asp.Net MVC applications and its key features are,
...
* [Annotations](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/asp-net-mvc/annotation/text-markup-annotation/) - Annotate with text markup, shapes, stamps, ink, and sticky notes.
* [Form Fields](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/asp-net-mvc/forms/overview/) - Form filling and form designing can be done.
* [Signature](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/asp-net-mvc/annotation/signature-annotation/) - Hand-written and digital signatures are allowed.
...
* [Download](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/asp-net-mvc/download/) - Download the complete document currently loaded in the PDF Viewer.
